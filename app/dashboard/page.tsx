...
import { Smartphone, Clock, AlertTriangle, CheckCircle, User, BookOpen, Users, FileText } from "lucide-react";
...
export default function AttendanceModule() {
  ...
  const currentSession = scheduleDataById[0]
    ? {
        ...
        teacher: "Current Teacher", // This should come from your data
      }
    : null;
        ...
        <Card>
          ...
          <CardContent>
                    ...
                    <div key={student.id} className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50 transition-colors">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          {student.nisn && <p className="text-xs text-gray-500">NISN: {student.nisn}</p>}
                        </div>
                      </div>
                      <div className="flex space-x-1">
            ...
            <div className="mt-4 flex justify-between items-center">
              <input type="file" accept="image/*" onChange={(e) => setSelectedFile(e.target.files?.[0]?.name || null)} className="text-sm" />
            ...
            <div className="space-y-3">
              <Alert className="border-yellow-200">
                ...
                <AlertDescription>
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="font-medium">Ahmad Rizki - {classData?.name}</p>
              ...
              <Alert className="border-red-200">
                ...
                <AlertDescription>
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="font-medium">Siti Nurhaliza - {classData?.name}</p>
