            ...
            <CardContent className="">
              <div className="flex flex-col md:flex-row items-center md:items-end gap-6 ">
                ...
                <div className="relative">
                  <Avatar className="w-28 h-28 border-4 border-white shadow-2xl ring-2 ring-blue-100">
                  ...
                  <div className="absolute -bottom-1 -right-1 w-8 h-8 bg-green-500 border-3 border-white rounded-full flex items-center justify-center">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3 p-3 rounded-lg bg-green-50">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-green-800">{user?.position}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-green-50">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-green-800">{user?.role?.name}</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-purple-50">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-purple-800 text-xs">{user?.id}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
